...
namespace ForeighExchange6.Services
{
    using ForeighExchange6.Helpers;
    using ForeighExchange6.Models;
    ...
    public class ApiService
    {
        public async Task<Response> CheckConnection()
        {
            if (!CrossConnectivity.Current.IsConnected)
            {
                ...
                {
                    IsSuccess = false,
                    Message = Lenguages.SettingConexionValidation 
                };
            }
            ...
            if(!response)
            {
                ...
                {
                    IsSuccess = false,
                    Message = Lenguages.ConexionInternetValidation
                };
            }
            return new Response
            {
